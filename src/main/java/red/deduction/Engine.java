...
import red.deduction.db.DbParser;
import red.deduction.model.Model;
import red.deduction.parser.Parser;
import red.deduction.parser.ParserException;
import red.deduction.presenter.ConsolePresenter;
import red.deduction.presenter.Presenter;
import red.deduction.txt.TxtParser;
import red.deduction.db.DbWriter;
import red.deduction.txt.TxtWriter;
import red.deduction.xml.XmlParser;
import red.deduction.xml.XmlWriter;
...
public class Engine {
    ...
    public void convert(
            String inputFile, FormatEnum fmtin, String inputConfigFile, String outputFile, FormatEnum fmtout, String outputConfigFile) {
        Model model;
        Parser parser;
        if (fmtin == fmtout) {

...
public class Tests extends Assert {
    ...
    public void test1() throws Exception {                           // валидный файл, тест на логику
        ...
        Main.main(new String[]{"deduce", "-t", s.getAbsolutePath()});
    ...
    public void test227() {                           // сложные правила
        ...
        Main.main(new String[]{"deduce", "-x", s.getAbsolutePath()});
    ...
    @Test
    public void test228() {                           // сложные правила

        File s1 = new File(getClass().getResource("logic.xml").getFile());
        File s2 = new File(getClass().getResource("checkxmllogic.txt").getFile());
        Main.main(new String[]{"convert", "-x", s1.getAbsolutePath(), "-t", "checkxmllogic.txt"});
